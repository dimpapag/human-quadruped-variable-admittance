...
csv_file = "src/command_give/Admittance_Logging/Tau_Z/adm_csv_2024-06-10_12-12-01.csv"
df = pd.read_csv(csv_file)
# Remove leading spaces from column names
df.columns = df.columns.str.strip()
#print(df.columns)
# Calculate power
df['Power(Watt)'] = df['f_x(N)'] * df['v_x(m/s)'] + df['f_y(N)'] * df['v_y(m/s)'] + df['tau_z(Nm)'] * df['omega_z(rad/s)']
