...
class SerialNode:
    def __init__(self):
        ...
        self.f_avg = 0.0  # Initialize the average value of Fs[0]
    ...
    def calculate_new_biases(self):
        ...
        # Calculate average Fs[0] value
        self.calculate_average_fs0()

        return True

    def calculate_average_fs0(self):
        fs0_values = []
        for data in self.collected_data:
            ...
            fs0_values.append(F_s[2])

        self.f_avg = np.mean(fs0_values)
        print(f"Calculated average Fs[0]: {self.f_avg}")
                ...
                try:
                    ...
                    if self.serial.in_waiting > 0:
                        ...
                        if len(values) >= 5:
                            ...
                            # Subtract the average value from Fs[0]
                            F_s[2] -= self.f_avg
